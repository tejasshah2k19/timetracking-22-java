					...
					<form class="md-float-material form-material" method="post"
						...
						<div class="auth-box card">
							<div class="card-block">
								...
								<p class="text-muted text-center p-b-5">Sign up with your
									regular account</p>

								<div class="form-group form-primary">
									<input type="text" name="firstName" class="form-control"
										required=""> <span class="form-bar"></span> <label
										class="float-label">Choose Firstname</label>
								</div>
									...
									<div class="col-sm-6">
										<div class="form-group form-primary">
											<input type="password" name="confirm-password"
												...
												class="form-bar"></span> <label class="float-label">Confirm
												Password</label>
										</div>
...
<![endif]-->
	...
	<script src="js/waves.min.js"
		type="a371f3c3996957007cacd73a-text/javascript"></script>
	...
	<script type="a371f3c3996957007cacd73a-text/javascript"
		src="js/i18next.min.js"></script>
	<script type="a371f3c3996957007cacd73a-text/javascript"
		src="js/i18nextxhrbackend.min.js"></script>
	<script type="a371f3c3996957007cacd73a-text/javascript"
		src="js/i18nextbrowserlanguagedetector.min.js"></script>
	<script type="a371f3c3996957007cacd73a-text/javascript"
		src="js/jquery-i18next.min.js"></script>
	<script type="a371f3c3996957007cacd73a-text/javascript"
  ...
  gtag('config', 'UA-23581568-13');
	...
	<script src="js/rocket-loader.min.js"
		data-cf-settings="a371f3c3996957007cacd73a-|49" defer=""></script>
</body>
